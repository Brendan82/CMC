...
function weaverii_mainopts_header() {
    ...
    array('name' => '#070<small>Hide on Mobile', 'id' =>'wii_header_html_hide_mobile' , 'type' => '+checkbox',	//code
...
?>
	...
	<br>
        <label>Hide Powered By tag: </label><input type="checkbox" name="<?php weaverii_sapi_main_name('_wii_hide_poweredby'); ?>" id="_wii_hide_poweredby" <?php checked(weaverii_getopt_checked( '_wii_hide_poweredby' )); ?> />
