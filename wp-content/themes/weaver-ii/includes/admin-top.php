...
<br /><br />
    ...
    <input type="checkbox" name="<?php weaverii_sapi_main_name('_wii_hide_donate'); ?>" id="wii_hide_donate" <?php checked(weaverii_getopt_checked( '_wii_hide_donate' )); ?> />
...
?>
    <input type="checkbox" name="<?php weaverii_sapi_main_name('_wii_hide_editor_style'); ?>" id="_wii_hide_editor_style" <?php checked(weaverii_getopt_checked( '_wii_hide_editor_style' )); ?> />
    ...
    <input type="checkbox" name="<?php weaverii_sapi_main_name('_wii_hide_updatemsg'); ?>" id="wii_hide_updatemsg" <?php checked(weaverii_getopt_checked( '_wii_hide_updatemsg' )); ?> />
    ...
    <input type="checkbox" name="<?php weaverii_sapi_main_name('_wii_hide_auto_css_rules'); ?>" id="wii_hide_auto_css_rules" <?php checked(weaverii_getopt_checked( '_wii_hide_auto_css_rules' )); ?> />
    ...
    <input name="<?php weaverii_sapi_main_name('_wii_css_rows'); ?>" id="wii_css_rows" type="text" style="width:30px;height:20px;" class="regular-text" value="<?php weaverii_esc_textarea(weaverii_getopt('_wii_css_rows')); ?>" />
...
<br />
<input type="checkbox" name="<?php weaverii_sapi_main_name('_wii_hide_PIE'); ?>" id="wii_hide_PIE" <?php checked(weaverii_getopt_checked( '_wii_hide_PIE' )); ?> />
 ...
 ?>
    ...
    <input type="checkbox" name="<?php weaverii_sapi_main_name('_wii_hide_mu_admin_per'); ?>" id="_wii_hide_mu_admin_per" <?php checked(weaverii_getopt_checked( '_wii_hide_mu_admin_per' )); ?> />
	<label>Hide Per Page/Post Options for MultiSite Admins</label> &diams;<br />
	   <input type="checkbox" name="<?php weaverii_sapi_main_name('_wii_hide_editor_per'); ?>" id="_wii_hide_editor_per" <?php checked(weaverii_getopt_checked( '_wii_hide_editor_per' )); ?> />
	<label>Hide Per Page/Post Options for Editors</label> &diams;<br />
	   <input type="checkbox" name="<?php weaverii_sapi_main_name('_wii_hide_author_per'); ?>" id="_wii_hide_author_per" <?php checked(weaverii_getopt_checked( '_wii_hide_author_per' )); ?> />
