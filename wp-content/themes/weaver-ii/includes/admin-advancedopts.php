...
<p>
    ...
    not commonly used, and is intended for more advanced Weaver II users to add &lt;script&gtl and &lt;style&gt;
...
?>
<div class="wvr-option-subheader"><label><span style="color:#999;"><b><?php echo $title; ?></b> - (Pro Version)</span></label></br></div></br />
<?php
...
?>
<div class="wvr-option-subheader"><label><span style="color:blue;"><b><?php echo $title; ?></b></span></label></div></br />
...
?>
    ...
    <br />
    <label>Hide on front page: </label><input type="checkbox" name="<?php weaverii_sapi_main_name($hide_front); ?>" id="<?php echo $hide_front; ?>" <?php checked(weaverii_getopt_checked($hide_front)); ?> />
    <small>If you check this box, then the code from this area will not be displayed on the front (home) page.</small><br />
    <label>Hide on non-front pages: </label><input type="checkbox" name="<?php weaverii_sapi_main_name($hide_rest); ?>" id="<?php echo $hide_rest; ?>" <?php checked(weaverii_getopt_checked( $hide_rest )); ?> />
    <small>If you check this box, then the code from this area will not be displayed on non-front pages.</small>
<?php
    if ($name == 'footer') {
?>
<br /><label>Move to before widget areas: </label><input type="checkbox" name="<?php weaverii_sapi_main_name('wii_footer_inject_move'); ?>" id="wii_footer_inject_move" <?php checked(weaverii_getopt_checked( 'wii_footer_inject_move' )); ?> />
...
?>
   ...
   <!-- ======== -->
    ...
    <div class="wvr-option-subheader"><label><span style="color:blue;font-size:larger;"><b>FavIcon</b></span></label></div></br />
...
<?php
    if (! weaverii_hide_advanced()) {
?>
   <div class="wvr-option-subheader"><label><span style="color:blue;font-size:larger;"><b>Preferred Image for Facebook</b></span></label></div></br />
...
?>
    <div class="wvr-option-subheader"><label><span style="color:blue;font-size:larger;"><b>Home Page</b></span></label></div>
    ...
    <div class="wvr-option-subheader"><label><span style="color:blue;font-size:larger;"><b>Author Avatars</b></span></label></div>
...
?>
	...
	<br>
         <label><em>Use SEO plugin instead:</em> </label><input type="checkbox" name="<?php weaverii_sapi_main_name('_wii_hide_metainfo'); ?>" id="_wii_hide_metainfo" <?php checked(weaverii_getopt_checked( '_wii_hide_metainfo' )); ?> />
